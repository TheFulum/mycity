...
public class LoginActivity extends AppCompatActivity {
    ...
    private void loginWithEmail() {
        ...
        auth.signInWithEmailAndPassword(email, password)
                .addOnSuccessListener(r -> checkPermanentBlockAndContinue())
    ...
    public void onPhoneAuthSuccess() { checkPermanentBlockAndContinue(); }

    private void checkPermanentBlockAndContinue() {
        ...
        userRepo.get(user.getUid())
                ...
                .addOnFailureListener(e -> {
                    setLoading(false);
                    showError("Ошибка проверки аккаунта");
                });
    }
